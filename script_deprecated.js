...
window.addEventListener('load', function() {
  ...
  if (!seen || false) {
    ...
    text.innerHTML = `welcome!
      ...
      <br>
      a demo can be found <a href="https://clipmaker.io" target="_blank">here</a>
      and usage information <a href="https://github.com/alisrbdni/clipmaker" target="_blank">here</a>.
      `;
    popup(text);
